...
def home_page():
    ...
    print(f"daily_unique_patient: { daily_unique_patient } | total_patient: { total_patient } | total_visit_count: { total_visit_count }")
...
def add_patient(): 
    ...
    if form.validate_on_submit(): 
        ...
        patient_module = models.Patient(patient_id, "0", form.name.data, form.birth_year.data, form.gender.data, form.phone.data, form.time.data, form.medical_record.data)
